...
type IpcMainEvent =
  ...
  /// The webContents that sent the message. You can call sender.send to reply to the asynchronous message.
  /// See webContents.send for more information.
  ...
  /// that you are currently handling. You should use this method to "reply" to the sent message in
  /// order to guaruntee the reply will go to the correct process and frame.
...
type CommonInterface =
  ...
  /// selection clipboard. To manipulate it you need to pass ClipboardType.Selection
  /// to relevant methods.
  ///
  ...
  /// Create tray, dock, and application icons using PNG or JPG files. In Electron,
  /// for the APIs that take images, you can pass either file paths or NativeImage
  /// instances. An empty image will be used when null is passed.
  ///
  /// https://electronjs.org/docs/api/native-image
  abstract NativeImage: NativeImageStatic with get, set
  /// Retrieve information about screen size, displays, cursor position, etc.
  /// You cannot require or use this module until the `ready` event of the `app`
  /// module is emitted. In the renderer process context it depends on the `remote`
  /// module, and is therefore not available when this module is disabled.
  ///
...
type MainInterface =
  ...
  /// Make HTTP/HTTPS requests. Also see the `net` module to create ClientRequest instances.
  ///
  ...
  /// bottlenecks and slow operations. This module does not include a web interface,
  /// so you need to open chrome://tracing/ in a Chrome browser and load the generated
  /// file to view the result. Note: You should not use this module until the `ready`
  ...
  /// shortcuts. Note: The shortcut is global; it will work even if the app does not
  /// have the keyboard focus. You should not use this module until the ready event
  /// of the app module is emitted.
  ///
  ...
  /// This module it handles asynchronous and synchronous messages sent from
  /// a renderer process (web page). Messages sent from a renderer will be
  /// emitted to this module.
  ///
...
type RendererInterface =
  ...
  /// provides a simple way to do inter-process communication (IPC) between
  /// the renderer process (web page) and the main process.
  abstract remote: Remote with get, set
  /// Customize the rendering of the current web page. This module is an instance
  /// of the WebFrame class representing the top frame of the current BrowserWindow.
...
type AppPathName =
  ...
  | AppData
  /// The directory for storing your app's configuration files, which
...
type SetJumpListResult =
  ...
  | Error
  /// An attempt was made to add a separator to a custom category in the Jump List.
  ...
  /// Custom categories can't be added to the Jump List due to user privacy
  /// or group policy settings.
...
type App =
  ...
  /// Emitted when Electron has finished initializing. You can call `app.isReady()` to check if
  /// this event has already fired.
  ///
  /// Extra parameters:
  ///
  ///   - launchInfo: On macOS, this object holds the `userInfo` of the
  ///     `NSUserNotification` that was used to open the application, if it
  ///     was launched from Notification Center
  ...
  /// the application.
  ///
  /// Note: If application quit was initiated by `autoUpdater.quitAndInstall()`, then
  /// `before-quit` is emitted *after* emitting the `close` event on all windows and closing them.
  ///
  ...
  /// [macOS] Emitted when the user wants to open a file with the application. The `open-file`
  ...
  /// this case (even before the `ready` event is emitted).
  ///
  /// You should call `event.preventDefault()` if you want to handle this event.
  ///
  /// On Windows, you have to parse `process.argv` (in the main process) to get the file path.
  ///
  /// Extra parameters:
  ///
  ///   - path
  ...
  /// [macOS] Emitted when the user wants to open a URL with the application. Your
  ...
  /// [macOS] Emitted when the application is activated. Various actions can trigger this
  ...
  /// [macOS] Emitted during macOS Handoff
  /// when an activity from a different device wants to be resumed. You should call
  ...
  /// [macOS] Emitted during macOS Handoff before an activity from a different device
  /// wants to be resumed. You should call event.preventDefault() if you want
  ...
  /// [macOS] Emitted during macOS Handoff when an activity from a different device fails to be resumed.
  ///
  /// Extra parameters:
  ///
  ///   - type: A string identifying the activity. Maps to NSUserActivity.activityType.
  ...
  /// [macOS] Emitted during macOS Handoff after an activity from this device was
  ...
  /// [macOS] Emitted when macOS Handoff is about to be resumed on another device. If you need to
  ...
  /// [macOS] Emitted when the user clicks the native macOS new tab button. The new tab button
  ...
  ///
  /// The default behavior is to cancel all authentications. To override this you should
  /// prevent the default behavior with event.preventDefault() and call
  ...
  /// [macOS, Windows] Emitted when Chrome's accessibility support changes. This event fires when
  ...
  /// Usually applications respond to this by making their primary window focused
  /// and non-minimized. This event is guaranteed to be emitted after the ready event
  /// of app gets emitted. Note:
  ///
  ...
  /// Exits immediately with `exitCode` (default 0). All windows will be
  ...
  /// arguments with current instance. When options.args is specified, the args will be
  /// passed as command line arguments instead. When options.execPath is specified,
  /// the execPath will be executed for relaunch instead of current app.
  ///
  /// Note that this method does not quit the app when executed. You have to call
  /// app.quit or app.exit after calling app.relaunch to make the app restart.
  ///
  /// When app.relaunch is called multiple times, multiple instances will be started
  /// after current instance exited.
  ...
  /// Returns a promise that is fulfilled when Electron is initialized. May be used as
  /// a convenient alternative to checking app.isReady() and subscribing to the `ready`
  ...
  /// [macOs] Shows application windows after they were hidden. Does not automatically
  /// focus them.
  abstract show: unit -> unit
  /// Returns the current application directory.
  abstract getAppPath: unit -> string
  /// Returns the specified special directory or file. On failure, an `Error` is thrown.
  ...
  /// this method. On failure an `Error` is thrown.
  ///
  /// By default, web pages' cookies and caches will be stored under the UserData directory.
  /// If you want to change this location, you have to override the UserData path
  ...
  /// application's package.json file, the version of the current bundle or executable
  /// is returned.
  abstract getVersion: unit -> string
  /// Returns the current application's name, which is the name in the application's
  /// package.json file.
  ///
  /// Usually the `name` field of package.json is a short lower-cased name, according to
  ...
  /// here: https://electronjs.org/docs/api/locales
  ///
  ...
  /// (aka URI scheme). It allows you to integrate your app deeper into the operating system.
  ...
  ///
  /// On Windows, you can provide optional parameters
  /// path (the path to your executable, defaults to process.execPath), and args,
  /// an array of arguments to be passed to your executable when it launches.
  ///
  ...
  /// Returns a value indicating whether the current executable is the default handler for a
  ...
  /// but the `type` property is omitted then the `type` is assumed to be `custom`.
  ///
  /// Note: Users can remove items from custom categories, and Windows will not allow a
  ...
  /// application and your app should continue loading. It returns false if your process
  /// should immediately quit as it has sent its parameters to another instance that has
  ...
  /// [macOS] Creates an NSUserActivity and sets it as the current activity. The activity is
  ...
  ///   - webpageURL: The webpage to load in a browser if no suitable app is installed on the
  ...
  /// [macOS] Updates the current activity if its type matches `type`, merging the
  /// entries from `userInfo` into its current `userInfo` dictionary.
  ///
  /// Parameters:
  ///   - type: Uniquely identifies the activity. Maps to NSUserActivity.activityType.
  ///   - userInfo: App-specific state to store for use by another device.
  abstract updateCurrentActivity: ``type``: string * userInfo: obj option -> unit
  /// Changes the Application User Model ID to `id`. More info: https://docs.microsoft.com/en-us/windows/desktop/shell/appids
  abstract setAppUserModelId: id: string -> unit
  /// [Linux] Imports the certificate in pkcs12 format into the platform certificate store.
  /// `callback` is called with the result of import operation. A value of `0` indicates
  /// success while any other value indicates failure according to Chromium
  /// net_error_list: https://cs.chromium.org/chromium/src/net/base/net_error_list.h
  ...
  /// For GpuInfoType.Complete, returns an object containing all
  /// the GPU Information in chromium's GPUInfo object. This includes the version
  /// and driver information that's shown on chrome://gpu page. For GpuInfoType.Basic,
  /// returns a subset of the complete info. Using Basic should be preferred if only
  /// basic information like vendorId or driverId is needed.
  abstract getGPUInfo: infoType: GpuInfoType -> Promise<obj>
  /// [Linux, macOS] Sets the counter badge for current app. Setting the count to 0 will hide the
  /// badge.
  ///
  /// On macOS, it shows on the dock icon. On Linux, it only works for Unity launcher.
  ///
  /// Note: Unity launcher requires the existence of a .desktop file to
  ...
  /// [macOS, Windows] If you provided path and args options to app.setLoginItemSettings,
  ...
  ///
  /// To work with Electron's autoUpdater on Windows, which uses Squirrel, you'll want to
  /// set the launch path to Update.exe, and pass arguments that specify your application name.
  abstract setLoginItemSettings: settings: SetLoginItemSettings -> unit
  /// [macOS, Windows] Returns true if Chrome's accessibility support is enabled, false otherwise.
  /// This API will return true if the use of assistive technologies, such as screen readers,
  /// has been detected. See chromium.org/developers/design-documents/accessibility for more details.
  abstract isAccessibilitySupportEnabled: unit -> bool
  /// [macOS, Windows] Manually enables Chrome's accessibility support, allowing to expose
  ...
  ///
  /// Note: Rendering accessibility tree can significantly affect the performance of your app.
  /// It should not be enabled by default.
  abstract setAccessibilitySupportEnabled: enabled: bool -> unit
  /// [macOS, Linux] Show the app's about panel options. These options can be overridden with
  /// app.setAboutPanelOptions(options).
  abstract showAboutPanel: unit -> unit
  /// [macOS, Linux] Set the about panel options. This will override the values defined in the app's
  ...
  /// [macOS (Mac App Store)] Start accessing a security scoped resource. With this method Electron
  ...
  ///
  /// Note: The returned function MUST be called once you have finished accessing the security
  /// scoped file. If you do not remember to stop accessing the bookmark, kernel resources will
  /// be leaked and your app will lose its ability to reach outside the sandbox completely,
  ...
  /// [macOS, Windows] Enables full sandbox mode on the app. This method can only be called before app
  /// is ready.
  abstract enableSandbox: unit -> unit
  /// [macOS] Indicates whether the application is currently running from the systems Application folder.
  /// Use in combination with app.moveToApplicationsFolder().
  abstract isInApplicationsFolder: unit -> bool
  /// [macOS] Returns a value indicating whether the move was successful. Please note
  ...
  ///
  /// Note: This method throws errors if anything other than the user causes the move to fail.
  ...
  /// Returns true if the app is packaged, false otherwise.
...
type CommandLine =
  ...
  ///
  /// Note: This will not affect process.argv, and is mainly used by developers to control some
...
type Dock =
  ...
  ///
  /// [macOS] When DockBounceType.Critical is passed, the dock icon will bounce until either the application
  /// becomes active or the request is canceled.
  ///
  /// When DockBounceType.Informational is passed, the dock icon will bounce for one second.
  /// However, the request remains active until either the application becomes active or the
  /// request is canceled.
  abstract bounce: DockBounceType -> int
  /// [macOS] Cancel the bounce of `id`.
  abstract cancelBounce: id: int -> unit
  /// [macOS] Bounces the Downloads stack if the `filePath` is inside the Downloads folder.
  ...
  abstract show: unit -> unit
  /// [macOS] Indicates whether the dock icon is visible. The app.dock.show() call is
  /// asynchronous so this method might not return true immediately after that call.
  abstract isVisible: unit -> bool
...
type JumpListSettings =
  ...
  /// For details, see https://docs.microsoft.com/en-us/windows/desktop/api/shobjidl_core/nf-shobjidl_core-icustomdestinationlist-beginlist
  abstract minItems: int with get, set
  /// Items that the user has explicitly removed from custom categories in the Jump List.
  /// These items must not be re-added to the Jump List in the next call to app.setJumpList().
...
type LoginItemSettings =
  ...
  /// [macOS] True if the app is set to open as hidden at login. This setting is not available
...
type GetLoginItemSettingsOptions =
  /// [Windows] The executable path to compare against. Defaults to process.execPath.
  abstract path: string with get, set
  /// [Windows] The command-line arguments to compare against. Defaults to an empty array.
...
type SetLoginItemSettings =
  ...
  /// to false.
  abstract openAtLogin: bool with get, set
  /// [macOS] True to open the app as hidden. Defaults to false. The user can edit this
  /// setting from the System Preferences, so app.getLoginItemSettings().wasOpenedAsHidden
  /// should be checked when the app is opened to know the current value.
  /// This setting is not available on Mac App Store builds.
  abstract openAsHidden: bool with get, set
  /// [Windows] The executable to launch at login. Defaults to process.execPath.
  abstract path: string with get, set
  /// [Windows] The command-line arguments to pass to the executable. Defaults to an empty
